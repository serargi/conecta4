...
If msgprincipal = True Or msgtab = True Or msgacerca = True Then
    'principal.txtNotas.Text = principal.txtNotas.Text & hora & "Rechazado automaticamente el reto de " & rival & vbCrLf
    principal.txtNotas.Text = principal.txtNotas.Text & hora & "Tienes otros avisos activos, cierralos primero" & vbCrLf
